...
`;
    ...
    var radio_group_styles_default = i$3`
  ${component_styles_default}
  ${form_control_styles_default}
...
`;
    ...
    var radio_button_styles_default = i$3`
...
`;
    ...
    /* src/TodoItem.svelte generated by Svelte v3.54.0 */
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			tr = element("tr");
    			td = element("td");
    			sl_checkbox = element("sl-checkbox");
    			t0 = text(/*todoName*/ ctx[0]);
    			t1 = space();
    			div = element("div");
    			div.textContent = "x";
    			set_custom_element_data(sl_checkbox, "contenteditable", "true");
    			set_custom_element_data(sl_checkbox, "checked", /*completedStatus*/ ctx[1]);
    			set_custom_element_data(sl_checkbox, "class", "svelte-1y53tn3");
    			toggle_class(sl_checkbox, "item-checked", /*completedStatus*/ ctx[1]);
    			add_location(sl_checkbox, file$2, 19, 8, 527);
    			attr_dev(div, "class", "remove-todo svelte-1y53tn3");
    			add_location(div, file$2, 24, 8, 787);
    			add_location(td, file$2, 17, 4, 513);
    			attr_dev(tr, "style", "");
    			add_location(tr, file$2, 16, 0, 493);
    		},
    		...
    		m: function mount(target, anchor) {
    			...
    			append_dev(tr, td);
    			append_dev(td, sl_checkbox);
    			append_dev(sl_checkbox, t0);
    			append_dev(td, t1);
    			append_dev(td, div);

    			if (!mounted) {
    				dispose = [
    					listen_dev(sl_checkbox, "sl-change", /*toggleComplete*/ ctx[3], true, false, false),
    					listen_dev(div, "click", /*todoDelete*/ ctx[2], false, false, false)
    				];
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*todoName*/ 1) set_data_dev(t0, /*todoName*/ ctx[0]);

    			if (dirty & /*completedStatus*/ 2) {
    				set_custom_element_data(sl_checkbox, "checked", /*completedStatus*/ ctx[1]);
    			}
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	function toggleComplete(event) {
    		...
    		console.log("event dispatched" + taskId);
    	}

    	$$self.$$.on_mount.push(function () {
    		if (taskId === undefined && !('taskId' in $$props || $$self.$$.bound[$$self.$$.props['taskId']])) {
    			console_1$1.warn("<TodoItem> was created without expected prop 'taskId'");
    		}

    		if (todoName === undefined && !('todoName' in $$props || $$self.$$.bound[$$self.$$.props['todoName']])) {
    			console_1$1.warn("<TodoItem> was created without expected prop 'todoName'");
    		}

    		if (completedStatus === undefined && !('completedStatus' in $$props || $$self.$$.bound[$$self.$$.props['completedStatus']])) {
    			console_1$1.warn("<TodoItem> was created without expected prop 'completedStatus'");
    		}
    	});

    	const writable_props = ['taskId', 'todoName', 'completedStatus'];
    	...
    	$$self.$$set = $$props => {
    		if ('taskId' in $$props) $$invalidate(4, taskId = $$props.taskId);
    		if ('todoName' in $$props) $$invalidate(0, todoName = $$props.todoName);
    		if ('completedStatus' in $$props) $$invalidate(1, completedStatus = $$props.completedStatus);
    	};
    	...
    	return [todoName, completedStatus, todoDelete, toggleComplete, taskId];
    }
    ...
    /* src/TodoCanvas.svelte generated by Svelte v3.54.0 */

    const { Object: Object_1, console: console_1 } = globals;
    const file$1 = "src/TodoCanvas.svelte";
    ...
    // (105:8) {#each filterTodoItems as todo}
    function create_each_block(ctx) {
    	...
    	todoitem = new TodoItem({
    			props: {
    				completedStatus: /*todo*/ ctx[11].completedStatus,
    				todoName: /*todo*/ ctx[11].name,
    				taskId: /*todo*/ ctx[11].id
    			},
    			$$inline: true
    		});

    	todoitem.$on("todoDelete", /*handleDelete*/ ctx[4]);
    	todoitem.$on("toggleComplete", /*handleToggleComplete*/ ctx[5]);
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*filterTodoItems*/ 4) todoitem_changes.completedStatus = /*todo*/ ctx[11].completedStatus;
    			if (dirty & /*filterTodoItems*/ 4) todoitem_changes.todoName = /*todo*/ ctx[11].name;
    			if (dirty & /*filterTodoItems*/ 4) todoitem_changes.taskId = /*todo*/ ctx[11].id;
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(105:8) {#each filterTodoItems as todo}",
    		ctx
    	});
    ...
    function create_fragment$1(ctx) {
    	...
    	let div0;
    	let sl_radio_group;
    	let sl_radio_button0;
    	let t6;
    	let sl_radio_button1;
    	let t8;
    	let sl_radio_button2;
    	let t10;
    	let div1;
    	let sl_button;
    	let t12;
    	...
    	let mounted;
    	let dispose;
    	let each_value = /*filterTodoItems*/ ctx[2];
    	...
    	const block = {
    		c: function create() {
    			...
    			table = element("table");
    			div0 = element("div");
    			sl_radio_group = element("sl-radio-group");
    			sl_radio_button0 = element("sl-radio-button");
    			sl_radio_button0.textContent = "All";
    			t6 = space();
    			sl_radio_button1 = element("sl-radio-button");
    			sl_radio_button1.textContent = "Completed";
    			t8 = space();
    			sl_radio_button2 = element("sl-radio-button");
    			sl_radio_button2.textContent = "Remaining";
    			t10 = space();
    			div1 = element("div");
    			sl_button = element("sl-button");
    			sl_button.textContent = "Clear Completed";
    			t12 = space();
    			tr = element("tr");
    			td = element("td");
    			sl_checkbox = element("sl-checkbox");
    			sl_checkbox.textContent = "Check All";
    			t14 = space();
    			span = element("span");
    			t15 = text(/*todoCounts*/ ctx[1]);
    			t16 = text(" Todo Items Remaining");
    			t17 = space();
    			...
    			attr_dev(h1, "class", "svelte-1e10gb6");
    			add_location(h1, file$1, 69, 4, 2434);
    			set_custom_element_data(sl_input, "label", "Enter your todo item");
    			set_custom_element_data(sl_input, "placeholder", "Todo Item Name");
    			set_custom_element_data(sl_input, "clearable", "");
    			add_location(sl_input, file$1, 70, 4, 2463);
    			set_custom_element_data(sl_radio_button0, "value", "all");
    			add_location(sl_radio_button0, file$1, 75, 16, 2786);
    			set_custom_element_data(sl_radio_button1, "value", "completed");
    			add_location(sl_radio_button1, file$1, 76, 16, 2854);
    			set_custom_element_data(sl_radio_button2, "value", "remaining");
    			add_location(sl_radio_button2, file$1, 77, 16, 2934);
    			set_custom_element_data(sl_radio_group, "name", "todo-option");
    			set_custom_element_data(sl_radio_group, "value", "1");
    			add_location(sl_radio_group, file$1, 74, 12, 2696);
    			set_style(div0, "padding-top", "10px");
    			attr_dev(div0, "class", "nine columns");
    			add_location(div0, file$1, 73, 8, 2631);
    			set_custom_element_data(sl_button, "variant", "neutral");
    			set_custom_element_data(sl_button, "outline", "");
    			add_location(sl_button, file$1, 89, 12, 3218);
    			...
    			add_location(div1, file$1, 88, 8, 3124);
    			add_location(sl_checkbox, file$1, 94, 18, 3368);
    			set_style(span, "float", "right");
    			set_style(span, "padding-right", "10px");
    			set_style(span, "margin-bottom", "20px");
    			set_style(span, "font-weight", "100");
    			set_style(span, "font-size", "14px");
    			set_style(span, "color", "grey");
    			add_location(span, file$1, 95, 16, 3450);
    			attr_dev(td, "class", "svelte-1e10gb6");
    			add_location(td, file$1, 94, 12, 3362);
    			attr_dev(tr, "style", "");
    			attr_dev(tr, "class", "svelte-1e10gb6");
    			add_location(tr, file$1, 93, 8, 3334);
    			set_style(table, "padding-top", "30px");
    			set_style(table, "width", "100%");
    			add_location(table, file$1, 72, 4, 2579);
    			set_style(div2, "padding", "5px");
    			set_style(div2, "margin", "0 auto");
    			add_location(div2, file$1, 68, 0, 2389);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			append_dev(h1, t2);
    			append_dev(div2, t3);
    			append_dev(div2, sl_input);
    			append_dev(div2, t4);
    			append_dev(div2, table);
    			append_dev(table, div0);
    			append_dev(div0, sl_radio_group);
    			append_dev(sl_radio_group, sl_radio_button0);
    			append_dev(sl_radio_group, t6);
    			append_dev(sl_radio_group, sl_radio_button1);
    			append_dev(sl_radio_group, t8);
    			append_dev(sl_radio_group, sl_radio_button2);
    			append_dev(table, t10);
    			append_dev(table, div1);
    			append_dev(div1, sl_button);
    			...
    			if (!mounted) {
    				dispose = [
    					listen_dev(sl_input, "keydown", /*addTodo*/ ctx[3], false, false, false),
    					listen_dev(sl_radio_group, "sl-change", /*filterTodos*/ ctx[6], false, false, false),
    					listen_dev(sl_button, "click", /*clearCompleted*/ ctx[7], false, false, false),
    					listen_dev(sl_checkbox, "sl-change", /*checkAllTodos*/ ctx[8], false, false, false)
    				];
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (!current || dirty & /*todoCounts*/ 2) set_data_dev(t15, /*todoCounts*/ ctx[1]);

    			if (dirty & /*filterTodoItems, handleDelete, handleToggleComplete*/ 52) {
    				each_value = /*filterTodoItems*/ ctx[2];
    				validate_each_argument(each_value);
    				let i;
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	let filterTodoItems;
    	let { $$slots: slots = {}, $$scope } = $$props;
    	validate_slots('TodoCanvas', slots, []);
    	let { name = "Todo App" } = $$props;
    	let countCheck = 1;
    	let todoCounts = 0;
    	...
    	function addTodo(event) {
    		let todoInput = event.target; //object's reference that is emiting event

    		if (event.key === 13 || event.key === 'Enter' && todoInput.value !== '') {
    			$$invalidate(9, todoItems = [
    				...todoItems,
    				{
    	...
    	function handleDelete(event) {
    		...
    		$$invalidate(9, todoItems = todoItems.filter(todoItems => todoItems.id !== event.detail.taskId));
    	}

    	function handleToggleComplete(event) {
    		let todoDoneIndex = todoItems.findIndex(todo => todo.id === event.detail.taskId);

    		let todoItemUpdated = Object.assign(Object.assign({}, todoItems[todoDoneIndex]), {
    			completedStatus: !todoItems[todoDoneIndex].completedStatus
    		});
    	...
    	function filterTodos(event) {
    		...
    		if (filterChoice === 'completed') $$invalidate(2, filterTodoItems = todoItems.filter(todo => todo.completedStatus === true));
    		if (filterChoice === 'remaining') $$invalidate(2, filterTodoItems = todoItems.filter(todo => todo.completedStatus === false));
    		if (filterChoice === 'all') $$invalidate(2, filterTodoItems = todoItems);
    	}

    	function clearCompleted() {
    		$$invalidate(9, todoItems = todoItems.filter(todo => todo.completedStatus === false));
    	}

    	function checkAllTodos() {
    		for (let index in todoItems) {
    			$$invalidate(9, todoItems[index].completedStatus = true, todoItems);
    		}
    	}
    	const writable_props = ['name'];

    	Object_1.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console_1.warn(`<TodoCanvas> was created with unknown prop '${key}'`);
    	});
    	...
    	$$self.$inject_state = $$props => {
    		if ('name' in $$props) $$invalidate(0, name = $$props.name);
    		if ('countCheck' in $$props) countCheck = $$props.countCheck;
    		if ('todoCounts' in $$props) $$invalidate(1, todoCounts = $$props.todoCounts);
    		if ('todoItems' in $$props) $$invalidate(9, todoItems = $$props.todoItems);
    		if ('filterTodoItems' in $$props) $$invalidate(2, filterTodoItems = $$props.filterTodoItems);
    	};
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*todoItems*/ 512) {
    			$$invalidate(2, filterTodoItems = todoItems);
    		}

    		if ($$self.$$.dirty & /*todoItems*/ 512) {
    			$$invalidate(1, todoCounts = todoItems.filter(todo => !todo.completedStatus).length);
    		}
    	};
    ...
    class TodoCanvas extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    	...
    	get name() {
    		throw new Error("<TodoCanvas>: Props cannot be read directly from the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}

    	set name(value) {
    		throw new Error("<TodoCanvas>: Props cannot be set directly on the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}
    }
    ...
    function create_fragment(ctx) {
    	...
    	let todocanvas;
    	let current;
    	todocanvas = new TodoCanvas({ $$inline: true });

    	const block = {
    		c: function create() {
    			main = element("main");
    			create_component(todocanvas.$$.fragment);
    			attr_dev(main, "class", "svelte-16b7fnz");
    			add_location(main, file, 15, 0, 844);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			mount_component(todocanvas, main, null);
    			current = true;
    		},
    		p: noop,
    		i: function intro(local) {
    			if (current) return;
    			transition_in(todocanvas.$$.fragment, local);
    			current = true;
    		},
    		o: function outro(local) {
    			transition_out(todocanvas.$$.fragment, local);
    			current = false;
    		},
    		d: function destroy(detaching) {
    			if (detaching) detach_dev(main);
    			destroy_component(todocanvas);
    		}
    	};
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ TodoCanvas, setBasePath });
    	return [];
    }
