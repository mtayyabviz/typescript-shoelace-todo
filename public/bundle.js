...
function create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(h1, file, 17, 1, 555);
			attr_dev(a, "href", "https://svelte.dev/tutorial");
			add_location(a, file, 18, 14, 592);
			add_location(p, file, 18, 1, 579);
			set_custom_element_data(sl_button0, "slot", "footer");
			set_custom_element_data(sl_button0, "variant", "primary");
			add_location(sl_button0, file, 21, 2, 802);
			set_custom_element_data(sl_drawer, "label", "Drawer");
			set_custom_element_data(sl_drawer, "class", "drawer-overview");
			add_location(sl_drawer, file, 19, 1, 690);
			add_location(sl_button1, file, 25, 3, 946);
			attr_dev(main, "class", "svelte-1tky8bj");
			add_location(main, file, 16, 0, 547);
		},
...
function instance($$self, $$props, $$invalidate) {
	...
	$$self.$capture_state = () => ({ setBasePath, drawerScript, name });
